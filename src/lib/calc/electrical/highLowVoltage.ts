 ...
 *
 * 電圧区分（低圧・高圧・特別高圧）の閾値は電気事業法施行規則第二条に
 * よるもので、日本の電気設計実務では広く知られた分類だが、当システムは
 * 経済産業省の最新版「電気設備の技術基準の解釈」原文でこの閾値を直接
 * 確認していないため `verified: false` とする。
 */
...
export const VOLTAGE_CLASS_SOURCE: TechnicalSource = {
  standard: "電気事業法施行規則",
  edition: "—",
  reference: "第二条（電圧の種別：低圧・高圧・特別高圧の定義）",
  applicability: "日本国内の電気工作物における電圧区分全般",
  sourceType: "standard",
  verified: false,
  verificationNote:
    "低圧（交流600V以下・直流750V以下）・高圧（交流600V超7000V以下・直流750V超7000V以下）・特別高圧（7000V超）" +
    "という区分は実務上広く知られているが、当システムは電気事業法施行規則および経済産業省「電気設備の技術基準の" +
    "解釈」の最新版原文でこの閾値を直接確認していない。本番運用前に原本を確認すること。",
};
