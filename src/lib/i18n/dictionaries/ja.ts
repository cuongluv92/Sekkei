...
const ja: Dictionary = {
  ...
  seismicCalc: {
    ...
    savedAt: "保存日: {date}",
    section1TitleCubicle: "①地震入力",
    section1HintCubicle: "設置都道府県・設置階・盤総重量を入力してください。地域係数Z・設置階係数Ks・Kh・Fh・Fvは自動で計算されます（単位はkgf — このキュービクル計算のみkN換算しません）。",
    prefectureLabel: "設置都道府県",
    cubicleFloor: {
      upper: "上層階・屋上・塔屋",
      middle: "中間階",
      ground: "地階・1階",
    },
    weightLabelKgf: "盤総重量 Wg（kgf）",
    section2TitleCubicle: "②盤諸元（寸法・アンカー配置）",
    section2HintCubicle: "盤の外形寸法とアンカーボルトの配置本数を入力してください。重心はアンカーピッチの中心にあるものとして自動計算します。",
    cubicleHHint: "盤重心高さ",
    cubicleLHint: "左右方向アンカーピッチ",
    cubicleSmallLHint: "前後方向アンカーピッチ",
    cubicleNHint: "アンカー総数",
    cubicleNtHint: "左右片側のアンカーボルト数",
    cubicleSmallNtHint: "前後片側のアンカーボルト数",
    cubicleHorizontalDirection: "左右方向",
    cubicleDepthDirection: "前後方向",
    cubicleOutlineDrawingHint: "H・L・l の測り方が分かる外形図を添付すると、入力ミスを防げます。",
    section3TitleCubicle: "③アンカーボルトの選定",
    section3HintCubicle: "施工方法とコンクリート厚さを選んでください。引張力・せん断力それぞれの許容荷重表、および施工方法別許容引抜荷重表から自動選定します。",
    section3AutoHintCubicle: "以下は自動選定です（表Ａ-１・表Ａ-２・表Ｂ-１～３のうち最も大きい径を採用）",
    cubicleTensionBolt: "引張力から（表A-1）",
    cubicleShearBolt: "せん断力から（表A-2）",
    cubiclePulloutBolt: "施工方法から（表B）",
    cubicleSelectedBolt: "選定結果",
    cubicleNoBoltFits: "M24でも不足",
    cubicleRecommendNote: "※弊社ではM12以上の使用を推奨するため、計算上の必要径より繰り上げています。",
    cubicleSourceTitle: "計算根拠・出典",
    cubicleSourceBody: "この「キュービクル」の計算は、自立形・壁掛形（JSIA-T1018:2012 5.1.1/5.1.2、単位kN、地域係数Zは昭55建告第1793号の全国表）とは別の計算体系です。実際に使用されているExcelツール（キュービクル.xlsx）の数値・表をそのまま採用しており、単位はkgfのまま、地域係数Z・設置階係数Ksの表もこのツール独自の値（例: 静岡=1.2は全国表には無い値）です。アンカーボルトの選定も、許容応力度(kN/mm2)ではなく、ボルト1本当たりの許容荷重(kgf)を表A-1/A-2（引張・せん断）および表B-1～3（施工方法・コンクリート厚さ別の許容引抜荷重）から直接読み取る方式です。出典が明確な公的標準の数値ではなく提供ツール固有の値であることを、あらかじめご了承ください。",
