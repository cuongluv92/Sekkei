...
const vi: Dictionary = {
  ...
  design: {
    ...
    schedule: {
      ...
      autoLabel: "tự động",
      endRefHint: "Ngày thật này chỉ dùng để tính màu ở 工程表, không thay đổi ô ngày (dạng chữ) bên trên.",
      ...
      milestones: {
        ...
        productionEnd: "製作完了日",
        productionEndRef: "Ngày thật để tô màu (bỏ trống sẽ không tô màu)",
        inspectionStart: "検査開始日",
        inspectionEnd: "検査完了日",
        inspectionEndRef: "Ngày thật để tô màu (bỏ trống sẽ không tô màu)",
        witnessStart: "立会開始日",
        witnessEnd: "立会完了日",
        witnessEndRef: "Ngày thật để tô màu (bỏ trống sẽ không tô màu)",
        shippingStart: "出荷開始日",
        shippingEnd: "出荷完了日",
        shippingEndRef: "Ngày thật để tô màu (bỏ trống sẽ không tô màu)",
        delivery: "納入日",
      },
      categories: {
        sheetMetal: "鈑金・BOX納入",
