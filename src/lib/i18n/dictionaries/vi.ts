...
const vi: Dictionary = {
  ...
  seismicCalc: {
    ...
    savedAt: "Ngày lưu: {date}",
    section1TitleCubicle: "①Tính lực động đất đầu vào",
    section1HintCubicle: "Nhập tỉnh/thành lắp đặt, tầng lắp đặt, tổng trọng lượng tủ. Hệ số vùng Z, hệ số tầng Ks, Kh, Fh, Fv sẽ tự động tính (đơn vị kgf — riêng module キュービクル này không đổi sang kN).",
    prefectureLabel: "Tỉnh/thành lắp đặt",
    cubicleFloor: {
      upper: "Tầng trên cùng・sân thượng・tháp mái",
      middle: "Tầng giữa",
      ground: "Tầng hầm・tầng 1",
    },
    weightLabelKgf: "Tổng trọng lượng tủ Wg (kgf)",
    section2TitleCubicle: "②Thông số tủ (kích thước・bố trí bu-lông)",
    section2HintCubicle: "Nhập kích thước ngoài của tủ và số lượng bu-lông neo. Trọng tâm được tự động tính là chính giữa khoảng cách bu-lông.",
    cubicleHHint: "Chiều cao trọng tâm tủ",
    cubicleLHint: "Khoảng cách bu-lông neo theo phương ngang (trái-phải)",
    cubicleSmallLHint: "Khoảng cách bu-lông neo theo phương trước-sau",
    cubicleNHint: "Tổng số bu-lông neo",
    cubicleNtHint: "Số bu-lông một bên theo phương ngang",
    cubicleSmallNtHint: "Số bu-lông một bên theo phương trước-sau",
    cubicleHorizontalDirection: "Phương ngang (trái-phải)",
    cubicleDepthDirection: "Phương trước-sau",
    cubicleOutlineDrawingHint: "Đính kèm bản vẽ ngoại hình thể hiện cách đo H・L・l sẽ giúp tránh nhập sai.",
    section3TitleCubicle: "③Chọn bu-lông neo",
    section3HintCubicle: "Chọn phương pháp thi công và độ dày bê tông. Hệ thống sẽ tự chọn theo bảng tải trọng cho phép của lực kéo/lực cắt và bảng tải trọng cho phép nhổ theo phương pháp thi công.",
    section3AutoHintCubicle: "Tự động chọn (lấy đường kính lớn nhất trong 3 bảng A-1・A-2・B-1~3)",
    cubicleTensionBolt: "Theo lực kéo (bảng A-1)",
    cubicleShearBolt: "Theo lực cắt (bảng A-2)",
    cubiclePulloutBolt: "Theo phương pháp thi công (bảng B)",
    cubicleSelectedBolt: "Kết quả chọn",
    cubicleNoBoltFits: "M24 cũng không đủ",
    cubicleRecommendNote: "※Công ty khuyến nghị dùng từ M12 trở lên, nên đã nâng lên so với đường kính tính toán tối thiểu.",
    cubicleSourceTitle: "Căn cứ tính toán・nguồn",
    cubicleSourceBody: "Tính toán mục 「キュービクル」 này là một hệ thống công thức RIÊNG BIỆT so với 自立形・壁掛形 (JSIA-T1018:2012 5.1.1/5.1.2, đơn vị kN, hệ số vùng Z theo bảng toàn quốc 昭55建告第1793号). Số liệu/bảng biểu lấy trực tiếp từ file Excel công ty đang thực tế sử dụng (キュービクル.xlsx): đơn vị giữ nguyên kgf, bảng hệ số vùng Z và hệ số tầng Ks là giá trị riêng của công cụ này (ví dụ: 静岡=1.2 không có trong bảng toàn quốc). Việc chọn bu-lông cũng không dùng ứng suất cho phép (kN/mm2) mà tra trực tiếp tải trọng cho phép của 1 bu-lông (kgf) từ bảng A-1/A-2 (kéo/cắt) và bảng B-1~3 (tải trọng nhổ cho phép theo phương pháp thi công・độ dày bê tông). Xin lưu ý đây là số liệu riêng của công cụ được cung cấp, không phải số liệu của một tiêu chuẩn công khai có nguồn rõ ràng.",
