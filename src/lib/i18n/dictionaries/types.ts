...
export interface Dictionary {
  ...
  ventilationCalc: {
    ...
    whyJudgeLabel: string;
    whyJudgeTitle: string;
  ...
  seismicCalc: {
    ...
    nTotalHint: string;
    whyRbQLabel: string;
    whyRbQTitleFloor: string;
    whyRbQBodyFloor: string;
    ...
    whyRbQTitleWall: string;
    whyRbQBodyWall: string;
