        ...
        {selectedKw == null ? (
          ...
          <div className="data-table-wrap mt-3">
            <table className="data-table table-fixed" style={{ minWidth: 900 }}>
              ...
              <tbody>
                {[
                  [copy.rated, naisen ? `${naisen.conventionalA} A（公開資料の参考値・要原本照合）` : "対象値なし", rowByBasis.company?.ratedCurrentA != null ? `${rowByBasis.company.ratedCurrentA} A` : "—", rowByBasis.mitsubishi?.ratedCurrentA != null ? `${rowByBasis.mitsubishi.ratedCurrentA} A` : "—", fuji ? `${fuji.ratedCurrentA} A` : rowByBasis.fuji?.ratedCurrentA != null ? `${rowByBasis.fuji.ratedCurrentA} A` : "—"],
