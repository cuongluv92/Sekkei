...
/**
 * 保存済み案件 — the one app-wide list of every 案件, reachable from the
 * shared CaseSelector (not a 部品製作-specific list). 開く sets the active
 * 案件; 編集 opens `EditCaseModal`; 削除 archives (soft delete, never a hard
 * DELETE — see `designCaseService.archive`) after warning the user when the
 * 案件 still has 部品製作/計算 data attached.
 */
