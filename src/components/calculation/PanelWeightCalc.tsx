 ...
 * but deliberately not implemented until specified. Already linked to a
 * Project (via `calculation_records`, calculation_type "weight-panel") so
 * the real save logic can be added later without restructuring.
 */
