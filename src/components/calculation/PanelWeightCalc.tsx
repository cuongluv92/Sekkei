 ...
 * but deliberately not implemented until specified.
 */
export function PanelWeightCalc() {
  ...
  return (
    <div className="panel">
      <div className="panel-body flex flex-col items-center gap-3 py-14 text-center">
        ...
        <p className="text-[14px] font-semibold text-foreground">{t("weightCalc.panel.title")}</p>
        <p className="max-w-md text-[12.5px] text-muted">{t("weightCalc.panel.comingSoon")}</p>
      </div>
    </div>
  );
}
